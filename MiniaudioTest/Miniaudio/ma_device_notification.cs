...
public unsafe partial struct ma_device_notification
{
    ...
    [NativeTypeName("union (anonymous union at miniaudio/src/miniaudio.h:6326:5)")]
    ...
    {
        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at miniaudio/src/miniaudio.h:6328:9)")]
        public _started_e__Struct started;

        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at miniaudio/src/miniaudio.h:6332:9)")]
        public _stopped_e__Struct stopped;

        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at miniaudio/src/miniaudio.h:6336:9)")]
        public _rerouted_e__Struct rerouted;

        [FieldOffset(0)]
        [NativeTypeName("struct (anonymous struct at miniaudio/src/miniaudio.h:6340:9)")]
